...
class Zamestnanec:
    ...
    #zamestnavatel, navysenie_platu a nastupny_plat sú "class variable", preto ju má každa inštancia Triedy Zamestnanec vlastnosť
    ...
    #Ako "constructor" t.j. metóda, ktorá vytvára inštanciu slúži "dunder/magic" metóda __new__(), ktorú netreba dávať do kódu, pokiaľ sa nejedná o zvláštny prípad


    #Dunder metóda __init__() slúži na nastavenie vlastností inštancie a je zavolaná vždy automaticky pri vytváraní inštancie;
    ...
    #V tomto prípade sa metóda __add__() snaží vráti súčet platov pokiaľ je aj druhý ščítanec inštanciou Triedy Zamestnanec;
    #Na overenie si, či je druhý ščítanec inštanciou Triedy Zamestnanec použijeme funkciu isinstance(); 
    #Funkcia isinstance() berei ako parametre inštanciu a Triedu, ktorej má byť prvý parameter inštanciou, vracia "bool" podľa toho, či je prvý parameter skutočne inštanciou;
    ...
    #Decorátor @property zmení metódu na vlastnosť, to znamená, že táto metóda sa zavolá vždy, keď sa volá vlastnost .email;
